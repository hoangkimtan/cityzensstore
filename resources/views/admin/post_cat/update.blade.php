        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    @endif
                    <div class="card-body">
                        <form action="{{ Route('admin.post_cat.update', $post_cat->id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">Tên danh mục</label>
                                <input class="form-control" type="text" name="post_cat_title"
                                    value="{{ $post_cat->post_cat_title }}" id="name">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="slug" value="{{ $post_cat->slug }}"
                                    id="slug">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="parent_id" id="">
                                    ...
                                    @if (!empty($list_post_cat))
                                        @foreach ($list_post_cat as $item)
                                            <option {{ $post_cat->parent_id == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">
                            ...
                            <button type="submit" name="btn_add" value="Thêm mới" class="btn btn-primary">Cập nhật</button>
                        </form>
                    </div>
                </div>
            </div>
